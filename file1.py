...
def rename_file1():
    ...
    new_nn = 'CM.CMFlex.Relatorios.Reports.ConfiguracaoDeRelatorioReport.mrt_' + ("{:04d}".format(functions.ano_atual)) + ("{:02d}".format(functions.mes_atual)) + '.xlsx'
